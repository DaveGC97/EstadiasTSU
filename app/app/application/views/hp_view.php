...
<head>
  ...
  <link rel="shortcut icon" href="<?= base_url().'static/images/m-1.png' ?>">
	<title>PV | Hojalatería y pintura</title>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
   ...
   <i class="fas fa-tools" style="color:#426AEF; font-size:20px;"></i> Servicios
    ...
    <div class="dropdown-menu dropdown-menu-right" >
       ...
       <button type="button" class="btn btn-light btn-block text-primary dropdown-item"><i class="fas fa-brush" style="color:#426AEF; font-size:20px;"></i> Hojalatería y pintura</button>
...
<div class="container col-sm-12">
  ...
  <div class="text-center" style="position: relative;">
      <img class="img-fluid" src="<?= base_url() ?>static/images/hp_info_1.jpg" alt="Mustang">
        <div style="background-color: #000; opacity: 0.7;box-shadow: 0 0 35px #000; position: absolute;
 bottom: 0%;
 left: 0;
 width: 100%;">
    <h1 style="font-size: 6vw; color: #fff;">Hojalatería y pintura</h1>
      </div>
  </div>
</div>
<br/>
<div class="row">
 ...
 <h4>Cuida la imagen de tu auto</h4>
 <p>La buena imagen de tu auto depende mucho de la pintura y sus acabados. ¡Permite que tu auto siga luciendo como nuevo! Contamos con cabina de pintura lo que ayuda a que el trabajo se lleve en un ambiente controlado sin polvo y en menor tiempo; ademas de ser amigable con el medio ambiente.</p>
 <br/>
	</div>
  <div class="col-sm-1"></div>
	</div>
...
<div class="row">
  <div class="col-sm-12" style="text-align: left;">
   <img class="img-fluid" src="<?= base_url() ?>static/images/hp_inicio.png" alt="Mustang" style="width: 30%;"> 
  </div>
</div>
