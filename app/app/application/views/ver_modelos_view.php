...
<head>
  ...
  <link rel="shortcut icon" href="<?= base_url().'static/images/m-1.png' ?>">
	<title>PV | Modelos</title>
<SCRIPT> var base_url = "<?= base_url() ?>"; </SCRIPT>
</head>
<body style="background-image: url('<?= base_url() ?>static/images/w3.jpg');background-repeat: no-repeat center center fixed; -webkit-background-size: cover;-moz-background-size: cover;background-size: cover;">
...
<nav class="navbar navbar-expand-sm navbar-info fixed-top" style="background-image: url('<?= base_url() ?>static/images/w6.jpg');background-repeat: no-repeat;background-position: center;background-size: cover; border-bottom: 2px solid #225CAA; box-shadow: 0 0 50px #000;">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <li class="nav-item" style="padding:5px">
      <button type="button" class="btn btn-light btn-block text-primary" ><i class="fas fa-car" style="color:#426AEF; font-size:20px;"></i> Modelos</button>
    </li>
...
<div class="row">
 <div class="text-center" style="position: relative;">
      <img class="img-fluid" src="<?= base_url() ?>static/images/mod_4.jpg" alt="Mustang">
        <div style="background-color: #000; opacity: 0.7;box-shadow: 0 0 35px #000; position: absolute;
 top: 45%;
 left: 0;
 width: 100%;">
    <h1 style="font-size: 4vw; color: #fff">Para los amantes del camino</h1>
      </div>
  </div>
</div>
<br/>
<div class="row">
	...
	<div class="col-sm-10 col-ms-offset-1">
    <div class="card" style="background-color: #F3F3F3;  border-top: 5px solid #225CAA;border-bottom: 1px solid #C9C9C9;">
   
   	<div class="card-body">
    <div class="row">
   	 <div class="col-sm-10 d-flex justify-content-center">
      <!-- Nav tabs -->
   <ul class="nav nav-tabs" id="tipo_carroceria">
      <!-- Nav con tipos de corrocerias -->
   </ul>
    ...
    <div class="row">
      <div class="col-sm-12">
       <!-- Tab panes -->
         ...
         <!-- Autos del tipo de carroceria seleccionado -->  
         </div>  
    ...
    <div class="modal-content">
      ...
      <strong>
          <span id="cliente"></span>
        	...
        	" recibirás un correo electronico, con información de la cotización"
      <!-- Modal footer -->
